...
export type PolicyAccess = 'VIEW'|'WRITE'|'MANAGE'|'CONNECT'|'SPEAK'
export type PolicyCondition = { kind: 'ALWAYS' } | { kind: 'ROLE_MATCH'; match: 'ANY'|'ALL'; role_ids: string[] } | { kind: 'SUBJECT_KIND'; subject_kind: 'MEMBER'|'BOT' }
