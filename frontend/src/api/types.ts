...
export type PolicyCondition = { kind: 'ALWAYS' } | { kind: 'ROLE_MATCH'; match: 'ANY'|'ALL'; role_ids: string[] } | { kind: 'SUBJECT_KIND'; subject_kind: 'MEMBER'|'BOT' } | { kind: 'BOT_MATCH'; bot_user_ids: string[] }
