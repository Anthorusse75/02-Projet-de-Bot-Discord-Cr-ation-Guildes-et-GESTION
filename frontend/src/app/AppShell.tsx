...
const navGroups = [
  { label: 'shell.workspace', sections: ['overview', 'structure', 'roles', 'permissions', 'policies', 'wizards'] as const },
...
const sectionGlyph: Record<string, string> = {
  overview: '⌂', structure: '⌘', roles: '◇', permissions: '◈', policies: '◆', wizards: '✺', plans: '▱', diagnostics: '◌', audit: '≡',
