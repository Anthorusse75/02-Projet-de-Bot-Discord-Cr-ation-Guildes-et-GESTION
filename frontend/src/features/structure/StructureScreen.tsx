...
export function StructureScreen() {
  ...
  const [includeHiddenDeleted, setIncludeHiddenDeleted] = useState(false); const query = useStructure(me.user.discord_user_id, guild.guild_id, includeHiddenDeleted); const [search, setSearch] = useState(''); const [problemKey, setProblemKey] = useState<'errors.authorization.denied'|'errors.generic'|null>(null)
