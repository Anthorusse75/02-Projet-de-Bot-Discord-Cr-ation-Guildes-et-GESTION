...
| Tests status | `python scripts/validate_stage.py 01` PASS — 22 unit, 4 integration, 3 frontend ; RLS A/B/absence/cross-write et pool reuse PASS ; GitHub Actions run `31950389082` PASS |
