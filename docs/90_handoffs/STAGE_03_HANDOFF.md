...
|---|---|---|
| `python scripts/validate_stage.py 03` | PASS, 93 unit + 43 integration + 4 frontend | `artifacts/test-evidence/stage-03/20260817T071933724741Z-275afb3b3a41-local-docker/` ; les Checks GitHub de la PR #3 sur son HEAD courant font autorité pour la validation finale pré-merge |
