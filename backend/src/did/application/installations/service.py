...
from did.domain.auth import AccessStatus, Capability, InstallationStatus, PlatformRole
...
class InstallationService:
    ...
    async def bootstrap(self, *, guild_id: int, actor_user_id: int) -> InstallationRecord:
        discovery = await self.authorization.discovery(actor_user_id, guild_id)
