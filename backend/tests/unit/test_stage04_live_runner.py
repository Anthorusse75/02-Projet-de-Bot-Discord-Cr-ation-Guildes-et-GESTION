...
def test_stage04_live_runner_is_governed_opt_in_redacted_and_read_only() -> None:
    source = Path("scripts/validate_discord_live_stage04.py").read_text(encoding="utf-8")
    ...
    assert "RedisDiscordWorkloadCoordinator" in source
